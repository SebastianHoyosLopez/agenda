...
export class Init1697601488176 implements MigrationInterface {
    name = 'Init1697601488176'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_reservation_access_level_enum" AS ENUM('30', '40', '50')`);
